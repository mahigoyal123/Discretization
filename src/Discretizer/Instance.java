...
/////////////////////////////////////////////////////////////////////////////
	...
	public Instance(double values[],InstanceAttributes ats){
		...
		for(int i=0;i<values.length;i++){
			...
			//is it missing?
			if( !Double.isNaN(values[i]) ) if(!(curAt.getType()==Attribute.NOMINAL)){ //is numerical?
                            switch (inOut) {
                                case 0->{
	...
	public void print (PrintWriter out){
		...
		for (int i=0; i<numInputAttributes; i++){
			...
			case Attribute.NOMINAL -> out.print(nominalValues[Instance.ATT_INPUT][i]);
			case Attribute.INTEGER -> out.print(realValues[Instance.ATT_INPUT][i]);
			case Attribute.REAL -> out.print(realValues[Instance.ATT_INPUT][i]);
			}
		}
		out.print("\n    > Outputs: ");
		for (int i=0; i<numOutputAttributes; i++){
			switch(Attributes.getOutputAttribute(i).getType()){
			case Attribute.NOMINAL -> out.print(nominalValues[Instance.ATT_OUTPUT][i]);
			case Attribute.INTEGER -> out.print(realValues[Instance.ATT_OUTPUT][i]);
			case Attribute.REAL -> out.print(realValues[Instance.ATT_OUTPUT][i]);
			}
		}
		out.print("\n    > Undefined: ");
	...
	private void printAttribute(PrintWriter out, int inOut, int ct, int type){
		...
		if (missingValues[inOut][ct]){
			...
			switch(type){
			case Attribute.NOMINAL -> out.print(nominalValues[inOut][ct]);
			case Attribute.INTEGER -> out.print((int)realValues[inOut][ct]);
			case Attribute.REAL -> out.print(realValues[inOut][ct]);
			}
		}
	}//end printAttribute
	...
	public void print (){
		...
		for (int i=0; i<numInputAttributes; i++){
			if (missingValues[Instance.ATT_INPUT][i]){
				...
				switch(Attributes.getInputAttribute(i).getType()){
				case Attribute.NOMINAL -> System.out.print(nominalValues[Instance.ATT_INPUT][i]);
				case Attribute.INTEGER -> System.out.print((int)realValues[Instance.ATT_INPUT][i]);
				case Attribute.REAL -> System.out.print(realValues[Instance.ATT_INPUT][i]);
				}
			}
			System.out.print("  ");
		}
		...
		for (int i=0; i<numOutputAttributes; i++){
			if (missingValues[Instance.ATT_OUTPUT][i]){
				...
				switch(Attributes.getOutputAttribute(i).getType()){
				case Attribute.NOMINAL -> System.out.print(nominalValues[Instance.ATT_OUTPUT][i]);
				case Attribute.INTEGER -> System.out.print((int)realValues[Instance.ATT_OUTPUT][i]);
				case Attribute.REAL -> System.out.print(realValues[Instance.ATT_OUTPUT][i]);
				}
			}
			System.out.print("  ");
		}
		...
		for (int i=0; i<numUndefinedAttributes; i++){
			if (missingValues[Instance.ATT_NONDEF][i]){
				...
				case Attribute.NOMINAL -> System.out.print(nominalValues[Instance.ATT_NONDEF][i]);
				case Attribute.INTEGER -> System.out.print((int)realValues[Instance.ATT_NONDEF][i]);
				case Attribute.REAL -> System.out.print(realValues[Instance.ATT_NONDEF][i]);
				}
			}
			System.out.print("  ");
		}
...
///////////////////////////////////////////////////////////////////////////// 
	...
	public String toString(){
		...
		for (int i=0; i<numInputAttributes; i++){
			...
			switch(Attributes.getInputAttribute(i).getType()){
			case Attribute.NOMINAL -> aux += nominalValues[0][i];
			case Attribute.INTEGER -> aux += (Integer.valueOf((int)realValues[0][i])).toString();
			case Attribute.REAL -> aux += (Double.valueOf(realValues[0][i])).toString();
			}
			aux += ending;
		}
		ending = ",";
		for (int i=0; i<numOutputAttributes; i++){
			...
			switch(Attributes.getOutputAttribute(i).getType()){
			case Attribute.NOMINAL -> aux += nominalValues[1][i];
			case Attribute.INTEGER -> aux += (Integer.valueOf((int)realValues[1][i])).toString();
			case Attribute.REAL -> aux += (Double.valueOf(realValues[1][i])).toString();
			}
			aux += ending;
		}  
		return aux;
...
//	NEW FUNCTIONS DEFINED FOR NON-STATIC ATTRIBUTES
	...
	public String toString(InstanceAttributes instAttributes){
		...
		for (int i=0; i<numInputAttributes; i++){
			...
			switch(instAttributes.getInputAttribute(i).getType()){
			case Attribute.NOMINAL -> aux += nominalValues[0][i];
			case Attribute.INTEGER -> aux += Integer.toString((int) realValues[0][i]);
			//case Attribute.REAL -> aux += ((realValues[0][i])).toString();
                        case Attribute.REAL -> aux += Double.toString(realValues[0][i]);
			}
			aux += ending;
		}
		ending = ",";
		for (int i=0; i<numOutputAttributes; i++){
			...
			switch(instAttributes.getOutputAttribute(i).getType()){
			case Attribute.NOMINAL -> aux += nominalValues[1][i];
			case Attribute.INTEGER -> aux += Integer.toString((int) realValues[1][i]);
			case Attribute.REAL -> aux += Double.toString(realValues[1][i]);
			}
			aux += ending;
		}  
		return aux;
