 ...
 */
  public String toString(){
    ...
    switch (type){
        ...
        case INTEGER -> {
            aux += " integer["+(Integer.valueOf((int)min)).toString();
            aux += ","+ (Integer.valueOf((int)max)).toString()+"]";
          }
        case REAL -> {
            aux += " real["+(Double.valueOf(min)).toString();
            aux += ","+ (Double.valueOf(max)).toString()+"]";
          }
    }
    return aux;
  }//end toString
 ...
 */
  public void print(){
      ...
      switch (type){
          ...
          case INTEGER -> System.out.print("["+(int)min+","+(int)max+"]");
          default -> System.out.print("["+min+","+max+"]");      
      }
      if (type == NOMINAL){
